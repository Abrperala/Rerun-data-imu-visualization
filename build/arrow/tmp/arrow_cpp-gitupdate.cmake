...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "apache-arrow-10.0.1"
  WORKING_DIRECTORY "/Users/abrahamperala/Desktop/STARX/Rerun Test/build/arrow/src/arrow_cpp"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/abrahamperala/Desktop/STARX/Rerun Test/build/arrow/src/arrow_cpp'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/abrahamperala/Desktop/STARX/Rerun Test/build/arrow/src/arrow_cpp'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
